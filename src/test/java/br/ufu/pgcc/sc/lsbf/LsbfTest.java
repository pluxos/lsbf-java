...
extends TestCase
{
    ...
    {
        Lsbf lsbf = new Lsbf();
        boolean[] result = lsbf.execute(200, 200, 2f, "/home/likewise-open/NETWORK/mourao/Workspace/projects/mestrado/lsbf-java/src/main/resources/200_data",
                                        "/home/likewise-open/NETWORK/mourao/Workspace/projects/mestrado/lsbf-java/src/main/resources/200_query");
